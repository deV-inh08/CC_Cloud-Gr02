  ...
  return (
    <section className='flex gap-20 mt-24 justify-center'>
      <div className='flex flex-col gap-4 items-center'>
        ...
        <h4 className='font-bold text-xl'>FREE AND FAST DELIVERY</h4>
        <p>Free delivery for all orders over $140</p>
      </div>
      <div className='flex flex-col gap-4 items-center'>
        <div className='bg-black w-[60px] h-[60px] rounded-full flex justify-center items-center'>
          <svg width={40} height={40} viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g id="Icon-Customer service" clipPath="url(#clip0_811_352)">
              <path id="Vector" d="M13.3334 24.9998C13.3334 23.1589 11.841 21.6665 10 21.6665C8.15907 21.6665 6.66669 23.1589 6.66669 24.9998V28.3332C6.66669 30.1741 8.15907 31.6665 10 31.6665C11.841 31.6665 13.3334 30.1741 13.3334 28.3332V24.9998Z" stroke="white" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
              <path id="Vector_2" d="M33.3334 24.9998C33.3334 23.1589 31.841 21.6665 30 21.6665C28.1591 21.6665 26.6667 23.1589 26.6667 24.9998V28.3332C26.6667 30.1741 28.1591 31.6665 30 31.6665C31.841 31.6665 33.3334 30.1741 33.3334 28.3332V24.9998Z" stroke="white" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
              <path id="Vector_3" d="M6.66669 24.9998V19.9998C6.66669 16.4636 8.07145 13.0722 10.5719 10.5717C13.0724 8.07126 16.4638 6.6665 20 6.6665C23.5362 6.6665 26.9276 8.07126 29.4281 10.5717C31.9286 13.0722 33.3334 16.4636 33.3334 19.9998V24.9998" stroke="white" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
              <path id="Vector_4" d="M30 31.6665C30 32.9926 28.9464 34.2644 27.0711 35.202C25.1957 36.1397 22.6522 36.6665 20 36.6665" stroke="white" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
            </g>
            <defs>
              <clipPath id="clip0_811_352">
                <rect width={40} height={40} fill="white" />
              </clipPath>
            </defs>
          </svg>
        </div>
        <h4 className='font-bold text-xl'>24/7 CUSTOMER SERVICE</h4>
      ...
      <div className='flex flex-col gap-4 items-center'>
        ...
        <h4 className='font-bold text-xl'>MONEY BACK GUARANTEE</h4>
